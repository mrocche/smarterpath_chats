(function() {
    ...
    function initChatWidget() {
        ...
        async function startNewConversation() {
            ...
            try {
                ...
                const botMessageContent = Array.isArray(responseData) ? responseData[0].output : responseData.output;
        ...
        async function sendMessage(message) {
            ...
            // Convert user Markdown message to HTML
            ...
            try {
                ...
                // Convert bot Markdown message to HTML
                botMessageDiv.innerHTML = marked.parse(botMessageContent);
                messagesContainer.appendChild(botMessageDiv);
                messagesContainer.scrollTop = messagesContainer.scrollHeight;
            } catch (error) {
    ...
    // Dynamically load Marked library and then initialize the chat widget
